...
@section('content')
    ...
    <div class="alert alert-warning" role="alert">
        ...
        </p><p><strong style="color: red;">"HomeUs - 1911697 - 0937497677"</strong></p>
        <p>Trong đó 1911697 là mã thành viên, 0937497677 là số điện thoại của bạn đăng ký trên website Homeus.com</p>
        <p>Xin cảm ơn!</p>
    </div>
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td style="white-space: nowrap;">HOÀNG NHƯ NGỌC</td>
            ...
            <td rowspan="6" style="white-space: nowrap; color: red;">Nội dung chuyển khoản, bạn ghi rõ:<br> <strong>"HomeUs - 1911697 - 0937497677"</strong><br><button class="btn btn-secondary btn-copy js-btn-copy" title="Sao chép liên kết" data-clipboard-text="HomeUs - 1911697 - 0937497677"><span class="icon-copy">Sao chép</span></button></td>
        </tr>
        <tr>
            ...
            <td style="white-space: nowrap;">CN HỒ CHÍ MINH</td>
            <!-- <td style="white-space: nowrap; color: red;">HomeUs - 1911697 - 0937497677</td> -->
        </tr>
        <tr>
