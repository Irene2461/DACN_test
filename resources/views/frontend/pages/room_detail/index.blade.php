...
@section('content')
    ...
    @include('components.room.title')
    @include('components.room.images_gallery')
    <div class="row mb-4">
        <div class="col">
            @include('components.room.information')
        </div>
        <div class="col-md-4 ps-4">
            @include('components.room.contact')
        </div>
    </div>
    @include('components.room.carousel_similar')
        ...
        <div class="content">
            ...
            <div class="card b-map">
                ...
                <div class="card-body">
                    ...
                    <p class="map-description">Mọi thông tin trên website chỉ mang tính chất tham khảo. Nếu bạn có phản hồi với tin đăng này (báo xấu, tin đã cho thuê, không liên lạc được,...), vui lòng thông báo để Home Us có thể xử lý.</p>
