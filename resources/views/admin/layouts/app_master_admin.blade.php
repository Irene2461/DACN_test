...
<header>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Home Us</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('get_admin.location.index') }}" title="Location">Location</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('get_admin.category.index') }}" title="Category">Category</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('get_admin.user.index') }}" title="User">User</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('get_admin.room.index') }}" title="Room">Room</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('get_admin.recharge.index') }}" title="Recharge">Recharge</a>
          </li>
...
<footer class="footer mt-auto py-3 bg-light">
  <div class="container">
    <span class="text-muted">Irene</span>
  </div>
</footer>
