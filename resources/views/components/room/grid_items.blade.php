@if($rooms->total())
    <div class="row mb-5 d-flex align-items-center">
        <div class="col-md-6">
            <div class="form-check-label">Tìm thấy {{ $rooms->where('status',3)->count(); }} kết quả.</div>
        </div>
...
@else
    <div class="my-5 form-check-label text-center fs-4">Không tìm thấy kết quả phù hợp.</div>    
@endif