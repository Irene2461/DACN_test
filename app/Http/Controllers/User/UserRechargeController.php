...
class UserRechargeController extends Controller
{
    ...
    protected function createPaymentAtm($rechargeHistory)
    {
        ...
        $vnp_TmnCode = "PCZCA2BQ"; //Website ID in VNPAY System
        $vnp_HashSecret = "NNHKQOUKJVIRHHLWFEOIMICXHSVNUABL"; //Secret key
        $vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
        $vnp_Returnurl = "http://homeus.vn/user/nap-tien/post-back-atm-internet-banking";
        ...
        $vnp_Inv_Customer = 'Hoàng Như Ngọc';
        $vnp_Inv_Address = 'Hồ Chí Minh';
        $vnp_Inv_Company = 'HCMUT';
