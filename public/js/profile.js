  ...
  sendCodeNumber: function sendCodeNumber() {
    $(".js-get-code-phone").click(function (event) {
      ...
      if ($phoneNew.length !== 10) {
        toastr__WEBPACK_IMPORTED_MODULE_1___default.a.error('Số điện thoại không hợp lệ', 'Thất bại');
        return;
      }
      toastr__WEBPACK_IMPORTED_MODULE_1___default.a.success('Mã code đã gủi tới số điện thoại hoạc email của bạn!', 'Thành công');
      return;
    });
  }
};
...
module.exports = __webpack_require__(/*! C:\Users\Admin\Desktop\seri\seri_phongtro\resources\assets\js\pages\profile.js */"./resources/assets/js/pages/profile.js");
