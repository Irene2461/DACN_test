...
Route::group(['namespace' => 'Frontend'], function(){
    ...
    Route::get('district','HomeController@loadDistrict')->name('get.load.district');
    Route::get('wards','HomeController@loadWards')->name('get.load.wards');

    Route::get('bang-gia','HomeController@getServicePrice')->name('get.service.price');

    Route::get('huong-dan/cho-thue','HomeController@getGuidelineDoRent')->name('get.guideline.do_rent.index');
    
    Route::get('huong-dan/thue','HomeController@getGuidelineGoRent')->name('get.guideline.go_rent.index');
...
Route::group(['namespace' => 'Auth'], function(){
    ...
    Route::post('huong-dan/cho-thue','LoginController@loginGuideDoRent')->name('get.guide.login');
    Route::post('huong-dan/thue','LoginController@loginGuideGoRent')->name('get.guide.login');
