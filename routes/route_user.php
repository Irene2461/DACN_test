...
Route::group(['namespace' => 'User', 'prefix' => 'user','middleware' => 'checkLoginUser'], function(){
    ...
    Route::group(['prefix' => 'room'], function(){
        ...
        Route::get('like','UserRoomController@index')->name('get_user.room.like');
        ...
        Route::get('update-hinh-anh/{id}','UserRoomController@editImage')->name('get_user.room.image.edit');
        Route::delete('/deleteimage/{id}','UserRoomController@deleteImage')->name('get_user.room.image.delete');
    });
